...
int sol(){
    ...
    For(M,6,6){
        ...
        For(id,1,1){
            ...
            alpha = 1; er = double(inf);
            bool first_time = true;
            while(er > eps){
                //cout << fixed << setprecision(9) << T << " " << fixed << setprecision(9) << alpha << el;
               // cout << fixed << setprecision(9) << T << el;
...
//                For(i,0,M) theta[i] = temp[i];
        ...
        rms /= n;
      // cout << "M = " << M << " then rms = " << fixed << setprecision(9) << rms << el;
      For(i,0,M) cout << theta[i] << " ";
       cout << el;
//       if(M == 6){
//            cout << T << el;
//            double x, y;
